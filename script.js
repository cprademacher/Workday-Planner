...
// in the html.
$(function () {
  // The code below saves various variables that I will need throughout this file.
  var hour9 = $('#hour-9');
  var hour10 = $('#hour-10');
  var hour11 = $('#hour-11');
  var hour12 = $('#hour-12');
  ...
  // The code below adds a listener for click events on the save button. This code
  // uses the id in the containing time-block as a key to save the user input in
  // local storage. It then uses `this` reference its parent container using DOM
  // traversal and check for each button's ID to determine which element to act on.
  saveButton.click(function() {
    ...
    // Below displays a message at the top when the save button is pressed
    // letting the user know that the item has been saved.  It then disappears
    // after 2 seconds.
    saved.text('Saved!');
    setTimeout(() => {
      saved.text('');
  ...
  //  The code below saves the current time (in hours) with the help of dayjs
  // to a variable and checks that time to be lesser than, equal to, or greater 
  // than the time blocks in the calendar's elements, then allowing it to 
  // determine which blocks need which colors depending on if they are in the 
